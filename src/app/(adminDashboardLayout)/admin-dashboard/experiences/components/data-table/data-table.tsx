...
import { ExperiencesDataTableToolbar } from "./toolbar";
...
export function ExperiencesDataTable<TData, TValue>({
  columns,
  data,
}: DataTableProps<TData, TValue>) {
  const rowSelectionEnabled = false;

  const searchColumns = ["title", "company"];
