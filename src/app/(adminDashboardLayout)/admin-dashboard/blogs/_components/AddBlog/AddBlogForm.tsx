...
import { createBlogValidationSchema } from "@/schemas/blog.schema";
import { IApiResponse } from "@/types";
import { IBlog, ICreateBlog } from "@/types/blog.type";
...
export function AddBlogForm({ closeModal }: IProps) {
    ...
    createBlog(formData, {
      onSuccess: (res: IApiResponse<IBlog>) => {
        if (res.statusCode === httpStatus.CREATED) {
          ...
          console.error(res);
          toast.error(
            res.message || "Failed to create blog. Please try again."
          );
        }
      },
      onError: (error) => {
